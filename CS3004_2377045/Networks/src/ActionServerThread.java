...
public class ActionServerThread extends Thread {
  ...
  private SharedActionState2 mySharedActionStateObject;
  private String myActionServerThreadName;
  private double mySharedVariable;
   
  
  	public ActionServerThread(Socket actionSocket, String ActionServerThreadName, SharedActionState2 SharedObject) {
