...
public class SharedActionState2 {
    ...
    public synchronized String processInput(String myThreadName, String theInput) {
        ...
        try {
            // --- 1. Customer Actions (Buy/Check) - For Thread 1 and Thread 2 ---
            if (myThreadName.equals("ActionServerThread1") || myThreadName.equals("ActionServerThread2")) {
                ...
                if (inputCommand.equals("check_stock")) {
                    ...
                    theOutput = myThreadName + " (Customer) received unrecognised command. Try Check_stock, Buy_apples (N), or Buy_oranges (N).";
                }
